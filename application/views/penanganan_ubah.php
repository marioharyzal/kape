	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h5 class="card-title mb-0">Ubah Data Penanganan</h5>
			</div>
			<div class="card-body">
				<form method="post" action="<?php echo base_url('index.php/penanganan/ubah/' .$penanganan->id_penanganan); ?>">
					<div class="mb-3">
						...
						<select name="id_penyakit" class="form-select mb-3" value="<?php echo $penyakit->id_penyakit; ?>">
				          ...
				          <?php foreach($penyakit as $row): ?>
					          <option value="<?php echo $row->id_penyakit; ?>" <?php if ($row->id_penyakit == $penanganan->id_penyakit): ?> selected <?php endif; ?>><?php echo $row->nm_penyakit; ?></option>
					      <?php endforeach; ?>
				        </select>
					</div>
					<div class="mb-3">
						...
						<select name="id_solusi" class="form-select mb-3" value="<?php echo $solusi->id_solusi; ?>">
				          ...
				          <?php foreach($solusi as $row): ?>
					          <option value="<?php echo $row->id_solusi; ?>" <?php if ($row->id_solusi == $penanganan->id_solusi): ?> selected <?php endif; ?>><?php echo $row->solusi; ?></option>
					      <?php endforeach; ?>
				        </select>
					</div>
